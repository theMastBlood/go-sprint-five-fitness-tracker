...
func (w Walking) Calories() float64 {
	// вставьте ваш код ниже
	return ((CaloriesWeightMultiplier * float64(w.Weight)) +
		(math.Pow((w.meanSpeed()*float64(KmHInMsec)), 2) / (w.Height / CmInM) * CaloriesSpeedHeightMultiplier * float64(w.Weight))) * w.Duration.Hours() * MinInHours
}
